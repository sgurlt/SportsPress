<?php
/**
 * Staff Statistics for Single League
 *
 * @author 		ThemeBoy
 * @category 	Admin
...
$output = '<h4 class="sp-table-caption">' . $caption . '</h4>' .
	...
	'<table class="sp-staff-statistics sp-data-table' . ( $scrollable ? ' sp-scrollable-table' : '' ) . '">' . '<thead>' . '<tr>';
...
?>
<div class="sp-template sp-template-staff-statistics">
	<?php echo $output; ?>
</div>
